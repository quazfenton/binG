 ...
 * - GET    /api/agents/pool/stats - Get pool statistics
 * 
 * @see lib/agents/agent-service-manager.ts
 * @see lib/agents/agent-pool.ts
 */
...
export { GETAgent as GET, POSTPrompt as POST };
