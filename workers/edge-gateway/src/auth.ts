...
// Backward-compat alias: the legacy local helper was named `decodeTokenUnverified`
// (now removed). Tests + a few internal call sites still use the old name.
export { decodeJwtUnverified as decodeTokenUnverified } from '@bing/shared/auth/jwt';
