 ...
 *   - events-schema.sql     → events, scheduled_tasks, approval_requests, event_healing_log
 *   - logging-schema.sql    → chat_request_logs, tool_calls, hitl_audit_logs
 *   - fs-edit-schema.sql    → fs_edit_transactions, fs_edit_denials
 *   - approval-requests.sql → approval_requests (human-in-loop variant with details/response)
