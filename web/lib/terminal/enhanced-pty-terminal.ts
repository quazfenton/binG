...
import { userTerminalSessionManager, type UserTerminalSession } from './session/user-terminal-sessions';
import { autoSnapshotService } from '../virtual-filesystem/sync/auto-snapshot-service';
import type { SandboxProviderType } from '../sandbox/providers';
import { LocalCommandExecutor, type LocalFilesystemEntry } from './commands/local-filesystem-executor';
