...
import { findAmpBinarySync, findCodexBinarySync, findKilocodeBinarySync, findPiBinarySync, findClaudeCodeBinarySync, findOpencodeBinarySync } from '../drivers/agent-bins'
...
class LLMService {
  ...
  private async initOpencodeClient(): Promise<void> {
    ...
    const { createOpenCodeSDKProvider } = await import('../engineers/opencode-sdk-provider')
