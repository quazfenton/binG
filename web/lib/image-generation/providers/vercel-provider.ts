...
export class VercelImageProvider implements ImageGenerationProvider {
  ...
  initialize(config: ProviderConfig): void {
    ...
    if (this.apiKey) {
      this.client = new OpenAI({
        ...
        dangerouslyAllowBrowser: true, // Only if this is used in-browser
      });
    }
  }
  ...
  async isAvailable(): Promise<boolean> {
    ...
    try {
      // Basic check - Vercel API might not support list() on models the same way
      return !!this.apiKey;
    } catch {
      return false;
    }
  ...
  async generate(
    ...
    try {
      ...
      const response = await this.client.images.generate({
        ...
        // @ts-ignore - Vercel/OpenAI-compatible parameters
