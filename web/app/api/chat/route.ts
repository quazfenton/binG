...
processUnifiedAgentRequest(currentConfig);
           ...
           */
              ...
              // Lock marker: do NOT migrate into runAutoContinueLoop — distinct semantic.
                  ...
                  chatLogger.warn('fileEdits-apply failed', { requestId, error: editErr?.message });
                  /* Bug #86 sentinel: fileEdits-apply error recovery — empty body; @audit-A2-migration-ready */
                }
              }