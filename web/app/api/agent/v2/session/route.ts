...
import { nullclawIntegration, type NullclawTask } from '../../packages/shared/agent/nullclaw-integration';
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (enableNullclaw) {
      const { initializeNullclaw, isNullclawAvailable } = await import('../../packages/shared/agent/nullclaw-integration');
