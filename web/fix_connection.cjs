...
} else { console.log('ERROR: schema end'); process.exit(1); }

// FIX 2: Add logging tables to tables object
...
if (content.includes(tablesClose)) { content = content.replace(tablesClose, tablesFixed); console.log('Fixed tables'); }
else { console.log('ERROR: tables close'); process.exit(1); }
