...
import { getToolManager } from '../../../web/lib/tools';
import { createLogger } from '../../../web/lib/utils/logger';
import { normalizeToolInvocation, type ToolInvocation } from '../../../web/lib/types/tool-invocation';
  ...
  return new ReadableStream({
    async start(controller) {
      ...
      try {
        ...
        try {
          const { diffTracker } = await import('../../../web/lib/virtual-filesystem/filesystem-diffs');
