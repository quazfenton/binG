...
describe('Agent Enhanced Features', () => {
  ...
  describe('Multi-Agent Collaboration', () => {
    const { MultiAgentCollaboration, createMultiAgentCollaboration, quickCollaborativeExecute } = require('@/lib/agents/multi-agent-collaboration');
  ...
  describe('Agent Memory Manager', () => {
    const { AgentMemoryManager, createAgentMemoryManager, quickAddMemory } = require('@/lib/agents/agent-memory');
  ...
  describe('Agent Integration: Collaboration + Memory', () => {
    it('should work together for context-aware collaboration', () => {
      const { MultiAgentCollaboration } = require('@/lib/agents/multi-agent-collaboration');
      const { AgentMemoryManager } = require('@/lib/agents/agent-memory');
