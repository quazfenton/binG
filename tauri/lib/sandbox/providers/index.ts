...
function initializeRegistry() {
  ...
  // Uses the user's real filesystem and shell for direct execution
  ...
  providerRegistry.set('desktop', {
    ...
    enabled: true,
    available: process.env.DESKTOP_MODE === 'true' || process.env.DESKTOP_LOCAL_EXECUTION === 'true',
    healthy: false,
    initializing: false,
    initPromise: null,
    failureCount: 0,
