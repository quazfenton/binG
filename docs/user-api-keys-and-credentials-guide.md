---
id: user-api-keys-and-credentials-guide
title: User API Keys & Credentials Guide
aliases:
  - USER_API_KEYS_GUIDE
  - USER_API_KEYS_GUIDE.md
  - user-api-keys-and-credentials-guide
  - user-api-keys-and-credentials-guide.md
tags:
  - guide
layer: core
summary: "# User API Keys & Credentials Guide\r\n\r\n**Manage your personal API keys for enhanced AI functionality**\r\n\r\n---\r\n\r\n## \U0001F3AF Overview\r\n\r\nThe **API Keys & Credentials** feature allows users to:\r\n\r\n1. **Override server-side API keys** with personal keys\r\n2. **Store credentials securely** in browser localSto"
anchors:
  - "\U0001F3AF Overview"
  - "\U0001F510 Security"
  - How Keys Are Stored
  - "\U0001F4F1 Accessing the Settings Page"
  - "\U0001F511 Managing API Keys"
  ...
  - Importing Keys
  - Clearing All Keys
  - "\U0001F504 How Keys Are Used"
  - Priority Order
  - Example Flow
  - "\U0001F5C4️ Database Persistence (Optional)"
  - Benefits
  - How to Enable
  - API Endpoints
  - "\U0001F52E OAuth Pre-Authorization (Coming Soon)"
  - What Is It?
  - Supported Services
  - How It Works
  ...
  - "\U0001F512 Security Best Practices"
  - DO ✅
  - DON'T ❌
  - "\U0001F41B Troubleshooting"
  - '"Keys not saving"'
  - '"Keys not working"'
