...
tags: []
layer: core
summary: "# Problem statement\r\nAgent execution, tool integration, and code/file side effects currently travel through mixed transports: canonicalized tool-invocation objects, provider-specific result shapes, message-parsed command blocks, and CLI-specific parsed outputs. This makes UI rendering, preview/apply"
anchors:
  - Current state
  - Proposed changes
  - Migration order
