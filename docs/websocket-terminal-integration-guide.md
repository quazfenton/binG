...
aliases:
  - WEBSOCKET_TERMINAL_INTEGRATION
  - WEBSOCKET_TERMINAL_INTEGRATION.md
  - websocket-terminal-integration-guide
  - websocket-terminal-integration-guide.md
tags:
  - terminal
  - websocket
  - guide
layer: core
summary: "# WebSocket Terminal Integration Guide\r\n\r\n## Overview\r\n\r\nThe WebSocket terminal is now available as the **DEFAULT** terminal connection method, replacing the event-based system.\r\n\r\n## What Changed\r\n\r\n### Backend (`lib/backend/websocket-terminal.ts`)\r\n- ✅ JWT authentication required for all connectio"
anchors:
  - Overview
  - What Changed
  - Backend (`lib/backend/websocket-terminal.ts`)
