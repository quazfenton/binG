...
aliases:
  - SPEC_AMPLIFICATION_FIX_PLAN
  - SPEC_AMPLIFICATION_FIX_PLAN.md
  - spec-amplification-timing-fix-plan
  - spec-amplification-timing-fix-plan.md
tags:
  - review
layer: core
summary: "# Spec Amplification Timing Fix Plan\r\n\r\n## Current Issues\r\n\r\n1. **Triggered in wrong scope**: Only runs inside ToolLoopAgent if block (line 2034)\r\n2. **Triggered too early**: Runs before final filesystem edits and done event\r\n3. **No separate message**: Background refinement events mix with original"
anchors:
  - Current Issues
  - Required Changes
