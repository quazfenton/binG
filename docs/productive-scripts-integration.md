---
id: productive-scripts-integration
title: Productive Scripts Integration
aliases:
  - PRODUCTIVE_SCRIPTS_INTEGRATION
  - PRODUCTIVE_SCRIPTS_INTEGRATION.md
  - productive-scripts-integration
  - productive-scripts-integration.md
tags: []
layer: core
summary: "# Productive Scripts Integration\r\n\r\n## Overview\r\n\r\nThis document describes the integration of capabilities.ts, bootstrap.ts, and the new productive scripts system with capability chains.\r\n\r\n---\r\n\r\n## Architecture\r\n\r\n```\r\n┌─────────────────────────────────────────────────────────┐\r\n│"
anchors:
  - Overview
  - Architecture
  - Integration Points
