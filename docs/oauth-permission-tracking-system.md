---
id: oauth-permission-tracking-system
title: OAuth Permission Tracking System
aliases:
  - oauth-permission-tracking
  - oauth-permission-tracking.md
tags:
  - auth
layer: core
summary: "# OAuth Permission Tracking System\r\n\r\n## Overview\r\n\r\nThe permission tracking system distinguishes between:\r\n1. **Basic OAuth Login** - Authentication only (profile, email)\r\n2. **Extended Permissions** - API access for automation (Gmail, Drive, Calendar, etc.)\r\n\r\nThis integrates with automation tools"
anchors:
  - Overview
  - Architecture
  - Database Schema
