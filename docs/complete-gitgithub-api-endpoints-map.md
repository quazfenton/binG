---
id: complete-gitgithub-api-endpoints-map
title: Complete Git/GitHub API Endpoints Map
aliases:
  - git-endpoints-complete-map
  - git-endpoints-complete-map.md
tags: []
layer: core
summary: "# Complete Git/GitHub API Endpoints Map\r\n\r\n## Existing Endpoints (Pre-Integration)\r\n\r\n### 1. `/api/integrations/github/route.ts` (ORIGINAL - 678 lines)\r\n**Purpose**: Unified GitHub integration for importing/cloning repos\r\n\r\n**GET Endpoints:**\r\n- `?type=trending&timeframe=daily|weekly|monthly` - **Sc"
anchors:
  - Existing Endpoints (Pre-Integration)
  - 1. `/api/integrations/github/route.ts` (ORIGINAL - 678 lines)
