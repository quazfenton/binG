---
id: opencode-v2-engine-nullclaw-integration-architecture
title: OpenCode V2 Engine + Nullclaw Integration Architecture
aliases:
  - V2_NULL_INTEGRATION_ARCHITECTURE
  - V2_NULL_INTEGRATION_ARCHITECTURE.md
  - opencode-v2-engine-nullclaw-integration-architecture
  - opencode-v2-engine-nullclaw-integration-architecture.md
tags:
  - v2
  - architecture
layer: core
summary: "# OpenCode V2 Engine + Nullclaw Integration Architecture\r\n\r\n## Executive Summary\r\n\r\nThis document outlines the comprehensive architecture for **OpenCode V2 Engine** - a Dockerized CLI-based agentic system that combines:\r\n\r\n1. **OpenCode CLI** - Primary coding agent with native bash, filesystem, and"
anchors:
  - Executive Summary
