---
id: mcp-store-and-discovery-system
title: MCP Store & Discovery System
aliases:
  - MCP_STORE
  - MCP_STORE.md
  - mcp-store-and-discovery-system
  - mcp-store-and-discovery-system.md
tags: []
layer: core
summary: "# MCP Store & Discovery System\r\n\r\n**Location:** `lib/mcp/mcp-store-service.ts` + `components/mcp/mcp-store.tsx`\r\n\r\n## Overview\r\n\r\nThe MCP Store is a comprehensive discovery and management system for MCP (Model Context Protocol) servers. It provides a unified interface for browsing, installing, and c"
anchors:
  - Overview
  - Features
  - "\U0001F310 Multi-Source Discovery"
  - "\U0001F510 API Key Management"
  - "\U0001F4E6 Server Management"
