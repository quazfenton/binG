---
id: sdk-examples-httpsgithub-comauth0nextjs-auth0blobmainexamples-mdon-the-serv
title: >-
  Examples
  https://github.com/auth0/nextjs-auth0/blob/main/EXAMPLES.md#on-the-server-app-router
aliases:
  - auth0-llms
  - auth0-llms.md
  - examples-httpsgithub-comauth0nextjs-auth0blobmainexamples-mdon-the-serv
  - examples-httpsgithub-comauth0nextjs-auth0blobmainexamples-mdon-the-serv.md
tags:
  - auth
layer: core
summary: "# Examples https://github.com/auth0/nextjs-auth0/blob/main/EXAMPLES.md#on-the-server-app-router\r\n\r\n\r\n- [Passing authorization parameters](#passing-authorization-parameters)\r\n- [The `returnTo` parameter](#the-returnto-parameter)\r\n  - [Redirecting the user after authentication](#redirecting-the-user-a"
anchors:
  ...
  - MFA Error Handling
---
# Examples https://github.com/auth0/nextjs-auth0/blob/main/EXAMPLES.md#on-the-server-app-router
