---
id: sdk-opensandbox-opensandbox-api-specifications
title: OpenSandbox API Specifications
aliases:
  - opensandbox-specs
  - opensandbox-specs.md
tags: []
layer: core
summary: "# OpenSandbox API Specifications\r\n\r\nEnglish | [中文](README_zh.md)\r\n\r\nThis directory contains OpenAPI specification documents for the OpenSandbox project, defining the complete API interfaces and data models. Use the server base URLs defined in each spec (for example, `http://localhost:8080/v1` for th"
anchors:
  - Specification Files
