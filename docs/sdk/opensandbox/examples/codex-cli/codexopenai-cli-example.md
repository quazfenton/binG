---
id: sdk-opensandbox-examples-codex-cli-codexopenai-cli-example
title: Codex/OpenAI CLI Example
aliases:
  - README
  - README.md
  - codexopenai-cli-example
  - codexopenai-cli-example.md
tags: []
layer: example
summary: "# Codex/OpenAI CLI Example\r\n\r\nUse the official `@openai/codex` npm package to call OpenAI/Codex-like models in OpenSandbox.\r\n\r\n## Start OpenSandbox server [local]\r\n\r\nPre-pull the code-interpreter image (includes Node.js):\r\n\r\n```shell\r\ndocker pull sandbox-registry.cn-zhangjiakou.cr.aliyuncs.com/opens"
anchors:
  - 'Start OpenSandbox server [local]'
