---
id: sdk-opensandbox-examples-aio-sandbox-all-in-one-aio-sandbox-example
title: All-in-One (AIO) Sandbox Example
aliases:
  - README
  - README.md
  - all-in-one-aio-sandbox-example
  - all-in-one-aio-sandbox-example.md
tags: []
layer: example
summary: "# All-in-One (AIO) Sandbox Example\r\n\r\nThis example demonstrates how to create and access an [All-in-One (AIO) Sandbox](https://github.com/agent-infra/sandbox) via OpenSandbox.\r\n\r\n## Start OpenSandbox server [local]\r\n\r\nYou can find the latest version [here](https://github.com/agent-infra/sandbox/pkgs"
anchors:
  - 'Start OpenSandbox server [local]'
