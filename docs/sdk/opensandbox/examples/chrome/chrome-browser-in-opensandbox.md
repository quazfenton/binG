---
id: sdk-opensandbox-examples-chrome-chrome-browser-in-opensandbox
title: Chrome Browser in OpenSandbox
aliases:
  - README
  - README.md
  - chrome-browser-in-opensandbox
  - chrome-browser-in-opensandbox.md
tags: []
layer: example
summary: "# Chrome Browser in OpenSandbox\r\n\r\nThis example runs Chrome Browser with OpenSandbox runtime.\r\n\r\nThe image starts a VNC server (`Xtigervnc :1`) and launches Chromium with remote debugging enabled on port `9222`.\r\n\r\n## Getting Chrome image\r\n\r\nYou can build the image from source or pull it from Docker"
anchors:
  - Getting Chrome image
  - Build from source
