---
id: sdk-opensandbox-examples-gemini-cli-gemini-cli-example
title: Gemini CLI Example
aliases:
  - README
  - README.md
  - gemini-cli-example
  - gemini-cli-example.md
tags: []
layer: example
summary: "# Gemini CLI Example\r\n\r\nCall Google Gemini via the `@google/gemini-cli` npm package in OpenSandbox.\r\n\r\n## Start OpenSandbox server [local]\r\n\r\nPre-pull the code-interpreter image (includes Node.js):\r\n\r\n```shell\r\ndocker pull sandbox-registry.cn-zhangjiakou.cr.aliyuncs.com/opensandbox/code-interpreter:"
anchors:
  - 'Start OpenSandbox server [local]'
