---
id: sdk-opensandbox-examples-docker-pvc-volume-mount-docker-pvc
title: Docker PVC（命名卷）挂载示例
aliases:
  - README_zh
  - README_zh.md
  - docker-pvc
