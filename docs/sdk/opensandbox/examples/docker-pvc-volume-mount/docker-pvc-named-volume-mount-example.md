---
id: >-
  sdk-opensandbox-examples-docker-pvc-volume-mount-docker-pvc-named-volume-mount-example
title: Docker PVC (Named Volume) Mount Example
aliases:
  - README
  - README.md
  - docker-pvc-named-volume-mount-example
  - docker-pvc-named-volume-mount-example.md
tags: []
layer: example
summary: "# Docker PVC (Named Volume) Mount Example\r\n\r\nThis example demonstrates how to mount Docker named volumes into sandbox containers using the OpenSandbox `pvc` backend. In Docker runtime, `pvc.claimName` maps to a Docker named volume -- providing a more convenient and secure alternative to host-path bi"
anchors:
