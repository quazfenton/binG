---
id: sdk-opensandbox-examples-host-volume-mount-host-volume-mount-example
title: Host Volume Mount Example
aliases:
  - README
  - README.md
  - host-volume-mount-example
  - host-volume-mount-example.md
tags: []
layer: example
summary: "# Host Volume Mount Example\r\n\r\nThis example demonstrates how to mount host directories into sandbox containers using the OpenSandbox Volume API. Host volume mounts enable bidirectional file sharing between the host machine and sandbox environments — ideal for sharing datasets, model checkpoints, con"
anchors:
  - Scenarios
  - Prerequisites
