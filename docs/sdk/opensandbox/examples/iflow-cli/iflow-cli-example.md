---
id: sdk-opensandbox-examples-iflow-cli-iflow-cli-example
title: iFlow CLI Example
aliases:
  - README
  - README.md
  - iflow-cli-example
  - iflow-cli-example.md
tags: []
layer: example
summary: "# iFlow CLI Example\r\n\r\nCall OpenAI-compatible iFlow/custom HTTP endpoints via the `iflow-cli` npm package in OpenSandbox.\r\n\r\n## Start OpenSandbox server [local]\r\n\r\nPre-pull the code-interpreter image (includes Node.js):\r\n\r\n```shell\r\ndocker pull sandbox-registry.cn-zhangjiakou.cr.aliyuncs.com/opensan"
anchors:
  - 'Start OpenSandbox server [local]'
