...
layer: core
summary: >-
  RPC mode enables headless operation of the coding agent via a JSON protocol
  over stdin/stdout. This is useful for embedding the agent in other
  applications, IDEs, or custom UIs.
anchors:
  - Starting RPC Mode
  - Protocol Overview
  - Framing
