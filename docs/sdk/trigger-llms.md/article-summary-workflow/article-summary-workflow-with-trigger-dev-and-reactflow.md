---
id: >-
  sdk-trigger-llms.md-article-summary-workflow-article-summary-workflow-with-trigger-dev-and-reactflow
title: Article summary workflow with Trigger.dev and ReactFlow
aliases:
  - README
  - README.md
  - article-summary-workflow-with-trigger-dev-and-reactflow
  - article-summary-workflow-with-trigger-dev-and-reactflow.md
tags:
  - implementation
layer: core
summary: "# Article summary workflow with Trigger.dev and ReactFlow\r\n\r\n> **ℹ️ Note:** This is a v4 project. If you are using v3 and want to upgrade, please refer to our [v4 upgrade guide](https://trigger.dev/docs/migrating-from-v3).\r\n\r\nCreate audio summaries of newspaper articles!\r\n\r\nhttps://github.com/user-a"
anchors:
  - Getting started
  - Walkthrough
  - Learn more
