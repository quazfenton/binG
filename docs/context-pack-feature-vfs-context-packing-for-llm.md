---
id: context-pack-feature-vfs-context-packing-for-llm
title: Context Pack Feature - VFS Context Packing for LLM
aliases:
  - CONTEXT_PACK_FEATURE
  - CONTEXT_PACK_FEATURE.md
  - context-pack-feature-vfs-context-packing-for-llm
  - context-pack-feature-vfs-context-packing-for-llm.md
tags: []
layer: core
summary: "# Context Pack Feature - VFS Context Packing for LLM\r\n\r\n## Overview\r\n\r\nThe **Context Pack** feature bundles the Virtual Filesystem (VFS) directory structure and file contents into dense, LLM-friendly formats. Inspired by tools like **Repomix** and **Gitingest**, this feature allows the LLM to effici"
anchors:
  - Overview
