---
id: orchestra-improvements-environment-configuration
title: Orchestra Improvements - Environment Configuration
aliases:
  - ORCHESTRA_ENV_CONFIG
  - ORCHESTRA_ENV_CONFIG.md
  - orchestra-improvements-environment-configuration
  - orchestra-improvements-environment-configuration.md
tags: []
layer: core
summary: "# Orchestra Improvements - Environment Configuration\r\n\r\n## New Environment Variables (Added in this update)\r\n\r\n### Task Classifier Configuration\r\n\r\n```bash\r\n# Task Classifier Thresholds\r\n# Complexity scores below this are classified as 'simple'\r\nTASK_CLASSIFIER_SIMPLE_THRESHOLD=0.3\r\n\r\n# Complexity s"
anchors:
  - New Environment Variables (Added in this update)
  - Task Classifier Configuration
