---
id: core-problem-with-current-tool-handling
title: Core Problem With Current Tool Handling
aliases:
  - toolsSCOUTS
  - toolsSCOUTS.md
tags: []
layer: core
summary: "You’ve already integrated an **unusually powerful stack** (Mastra, CrewAI, Vercel AI SDK, OpenAI/Mistral Agents, Composio, multiple sandboxes). The main weakness you identified is correct:\r\n\r\n> **Manual tool wiring does not scale.**\r\n\r\nYou currently have a **flat tool list** (~40 tools). Advanced ag"
anchors:
