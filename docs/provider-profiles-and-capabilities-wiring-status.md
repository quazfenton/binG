---
id: provider-profiles-and-capabilities-wiring-status
title: Provider Profiles & Capabilities Wiring Status
aliases:
  - PROVIDER_CAPABILITIES_WIRING_STATUS
  - PROVIDER_CAPABILITIES_WIRING_STATUS.md
  - provider-profiles-and-capabilities-wiring-status
  - provider-profiles-and-capabilities-wiring-status.md
tags: []
layer: core
summary: "# Provider Profiles & Capabilities Wiring Status\r\n\r\n## Overview\r\n\r\nThis document tracks the wiring status between **Provider Profiles** (from `lib/sandbox/provider-router.ts`) and **Capability Definitions** (from `lib/tools/capabilities.ts`).\r\n\r\n---\r\n\r\n## Provider Profiles (10 Total)\r\n\r\nFrom `lib/sa"
anchors:
  - Overview
  - Provider Profiles (10 Total)
