---
id: user-feature-overrides-implementation
title: User Feature Overrides Implementation
aliases:
  - USER_FEATURE_OVERRIDES
  - USER_FEATURE_OVERRIDES.md
  - user-feature-overrides-implementation
  - user-feature-overrides-implementation.md
tags:
  - implementation
layer: core
summary: "# User Feature Overrides Implementation\r\n\r\n## Overview\r\n\r\nUsers can now override environment variables for **OpenCode** and **Nullclaw** features through the Settings panel. Preferences are:\r\n- ✅ Saved to **localStorage** (immediate, works offline)\r\n- ✅ Synced to **database** (persists across device"
anchors:
  - Overview
  - Architecture
