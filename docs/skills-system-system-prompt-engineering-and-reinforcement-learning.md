---
id: skills-system-system-prompt-engineering-and-reinforcement-learning
title: Skills System - System Prompt Engineering & Reinforcement Learning
aliases:
  - SKILLS_SYSTEM
  - SKILLS_SYSTEM.md
  - skills-system-system-prompt-engineering-and-reinforcement-learning
  - skills-system-system-prompt-engineering-and-reinforcement-learning.md
tags:
  - skills
layer: core
summary: "# Skills System - System Prompt Engineering & Reinforcement Learning\r\n\r\n**Location:** `lib/skills/`\r\n\r\n## Overview\r\n\r\nThe Skills System provides a sophisticated framework for:\r\n- **Skill.md parsing** - Structured skill definitions with context\r\n- **EJSON object passing** - Structured data for skill"
anchors:
  - Overview
  - Architecture
  - Skill Structure
