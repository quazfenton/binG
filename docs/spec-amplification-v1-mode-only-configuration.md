---
id: spec-amplification-v1-mode-only-configuration
title: Spec Amplification - V1 Mode Only Configuration
aliases:
  - SPEC_AMPLIFICATION_V1_MODE
  - SPEC_AMPLIFICATION_V1_MODE.md
  - spec-amplification-v1-mode-only-configuration
  - spec-amplification-v1-mode-only-configuration.md
tags: []
layer: core
summary: "# Spec Amplification - V1 Mode Only Configuration\r\n\r\n## Overview\r\n\r\nThe spec amplification system is designed to work **exclusively with V1 mode** (regular LLM calls). V2 agent mode has its own planning and execution system and should not use spec amplification.\r\n\r\n---\r\n\r\n## Mode Detection\r\n\r\n### V1"
anchors:
  - Overview
  - Mode Detection
