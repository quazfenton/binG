...
export const ERROR_CODES = {
  ...
  STREAMING: {
    REQUEST_FAILED: 'STREAM_001',
    CHUNK_PROCESSING_FAILED: 'STREAM_002',
    CONTEXT_WINDOW_EXCEEDED: 'STREAM_003',
    VALIDATION_FAILED: 'STREAM_004',
    CONNECTION_TIMEOUT: 'STREAM_005',
    ASSEMBLY_FAILED: 'STREAM_006',
    COMPLETION_FAILED: 'STREAM_007'
  },
  AGENTIC: {
  ...
  FILE_MANAGEMENT: {
    ...
    INVALID_OPERATION: 'FILE_008',
    FILE_OPERATION_FAILED: 'FILE_009',
    INVALID_INPUT: 'FILE_010',
    INVALID_PATH: 'FILE_011',
    FILE_EXISTS: 'FILE_012',
    INVALID_RANGE: 'FILE_013'
  },
  PROMPT_ENGINE: {
  ...
  SAFE_DIFF: {
    ...
    SEMANTIC_ANALYSIS_FAILED: 'DIFF_007',
    UNKNOWN_RESOLUTION_TYPE: 'DIFF_008'
  },
  LLM: {
